...
function delete_cart_goods(cart_id){
    ...
    formObj.method="post";
    formObj.action="/bookshop01/cart/deleteCartGoods.do";
    formObj.submit();
}
			 ...
			 <tr>       
               <form name="frm_order_all_cart">
				      <c:forEach var="item" items="${cartHash.my_goods_list }" varStatus="cnt">
				       <c:set var="cart_goods_qty" value="${cartHash.my_cart_list[cnt.count-1].cart_goods_qty}" />
				       <c:set var="cart_id" value="${cartHash.my_cart_list[cnt.count-1].cart_id}" />
